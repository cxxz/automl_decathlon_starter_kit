    ...
    def train(
        ...
        ****************************************************************************
        ...
        if steps_to_train <= 0:
            ...
            # Training loop
            steps_to_train = len(self.trainloader) * self.num_epochs_we_want_to_train
            logger.info(f"steps to train {steps_to_train}")
            logger.info(f"epochs to train {self.num_epochs_we_want_to_train}")
